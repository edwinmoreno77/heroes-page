...
export const Slider = () => {
    return (
        <>
            <section id="Inicio" className="img-bg-navbar bg-dark ">
                    ...
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <div className="d-flex justify-content-center img-carousel-1">
                                <img src="https://images2.alphacoders.com/673/673843.jpg" className="d-block" alt="..." />
                            </div>
                        ...
                        <div className="carousel-item">
                            <div className="d-flex justify-content-center img-carousel-2">
                                <img src="https://images6.alphacoders.com/509/509753.jpg" className="d-block" alt="..." />
                            </div>
                            <div className="carousel-caption d-none d-md-block text-dark">
                            </div>
                        </div>
                        <div className="carousel-item active">
                            <div className="d-flex justify-content-center img-carousel-3">
                                <img src="https://images8.alphacoders.com/113/1138298.jpg" className="d-block" alt="..." />
                            </div>
                            <div className="carousel-caption d-none d-md-block text-dark">
                            </div>
                        </div>
